...
<p align="center">
  <img src="docs/images/logo-horizontal.svg" alt="Claude Code token free" width="480">
</p>
...
[![Docs](https://img.shields.io/badge/📖_Documentation-Visit-D97757)](https://github.com/hyqibot/claude-code-token-free)

</div>

> **Public repository notice**: Download desktop builds from [Releases](https://github.com/hyqibot/claude-code-token-free/releases). **Zero-Token (free-token) mode requires the Release installer** — it ships prebuilt sidecars; you cannot build the full Zero-Token gateway from this public source tree.
...
The Claude Code token free desktop app brings sessions, multi-project navigation, code diffs, permission review, provider setup, scheduled tasks, and IM adapters into one graphical workspace for daily development flows beyond the terminal.

<p align="center">
  <a href="https://github.com/hyqibot/claude-code-token-free/releases"><img src="https://img.shields.io/badge/⬇_Download_Desktop-macOS_%7C_Windows-D97757?style=for-the-badge" alt="Download Desktop"></a>
  &nbsp;
...
> **Public source tree**: Zero-Token sidecars are **not** in this repo. Use [Releases](https://github.com/hyqibot/claude-code-token-free/releases) for free-token mode. `build:sidecars` / `tauri build` here will **not** produce a Zero-Token desktop installer.
...
If this project helps you, please support it with a ⭐ Star so more people can discover Claude Code token free.
