  ...
  return (
    ...
    >
      <div className={compact ? 'mx-auto max-w-full' : 'mx-auto max-w-[860px]'}>
        ...
        {streamingText.trim() && (
          <AssistantMessage content={streamingText} isStreaming={chatState === 'streaming'} sessionId={resolvedSessionId} />
        )}
...
export const MessageBlock = memo(function MessageBlock({
  ...
  switch (message.type) {
    ...
    case 'assistant_text':
      return <AssistantMessage content={message.content} sessionId={sessionId} />
    case 'thinking':
