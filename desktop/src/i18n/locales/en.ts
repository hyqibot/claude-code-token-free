export const en = {
  ...
  'settings.providers.deepseekToolModeDsml': 'DSML (default, native DeepSeek web format)',
  'settings.providers.deepseekToolModeXml': 'Doubao XML (<tool_call>, same as doubao-web)',
