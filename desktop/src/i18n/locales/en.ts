export const en = {
  ...
  'settings.claudeOfficialLogin.openBrowserFailed': 'Could not open the browser automatically; click the authorization link.',
  'settings.claudeOfficialLogin.manualAuthorizeLink': 'Open authorization link',
  ...
  'settings.providers.zeroTokenTitle': 'Zero-Token Gateway',
  'settings.providers.zeroTokenWebModelHint':
    'If the gateway status is not Running, click Start Gateway.',
  'settings.providers.zeroTokenWebModelDeepseekChat': 'DeepSeek Web',
  'settings.providers.zeroTokenWebModelDoubaoWeb': 'Doubao Web',
  'settings.providers.zeroTokenWebModelClaudeWeb': 'Claude Web',
  'settings.providers.zeroTokenWebModelQwenWeb': 'Qwen Web',
  'settings.providers.zeroTokenWebModelQwenCnWeb': 'Qwen CN Web',
  'settings.providers.zeroTokenWebModelKimiWeb': 'Kimi Web',
  'settings.providers.zeroTokenWebModelChatgptWeb': 'ChatGPT Web',
  'settings.providers.zeroTokenWebModelGeminiWeb': 'Gemini Web',
  'settings.providers.zeroTokenWebModelGlmWeb': 'GLM Web',
  'settings.providers.zeroTokenWebModelGlmIntlWeb': 'GLM Intl Web',
  'settings.providers.zeroTokenNoStatus': 'No status yet.',
  'settings.providers.zeroTokenRunning': 'Running',
  'settings.providers.zeroTokenStoppedState': 'Stopped',
  'settings.providers.zeroTokenStart': 'Start Gateway',
  'settings.providers.zeroTokenStop': 'Stop Gateway',
  'settings.providers.zeroTokenAuthorize': 'Authorize',
  'settings.providers.zeroTokenPhaseEnsure': 'Step 1/3: Chrome debug + open site',
  'settings.providers.zeroTokenPhaseOnboard': 'Step 2/3: CLI onboard (capture credentials)',
  'settings.providers.zeroTokenPhaseKeepalive': 'Step 3/3: Keepalive subprocess',
  'settings.providers.zeroTokenAuthorizeWaiting': 'Connecting to server…',
  'settings.providers.zeroTokenStarted': 'Zero-Token gateway started',
  'settings.providers.zeroTokenStopped': 'Zero-Token gateway stopped',
  'settings.providers.zeroTokenAuthorizeSuccess': 'Authorized {id} (onboard={mode})',
  'settings.providers.zeroTokenStatusFailed': 'Failed to load Zero-Token status',
  'settings.providers.zeroTokenStartFailed': 'Failed to start Zero-Token gateway',
  'settings.providers.zeroTokenStopFailed': 'Failed to stop Zero-Token gateway',
  'settings.providers.zeroTokenAuthorizeFailed': 'Zero-Token authorize failed',
  'settings.providers.zeroTokenTlsHint':
    'If chat shows "unknown certificate verification error", enable "Trust all certificates under HTTPS proxy" under Settings → General, stop and restart the Zero-Token gateway, then start a new session.',
  'settings.providers.deepseekToolModeLabel': 'DeepSeek toolchain',
  'settings.providers.deepseekToolModeXml': 'Doubao XML (default, <tool_call>, same as doubao-web)',
  'settings.providers.deepseekToolModeDsml': 'DSML (native DeepSeek web format, may trigger risk control)',
  'settings.providers.deepseekToolModeDsmlRiskHint':
    'DSML uses DeepSeek-specific tool markup. Long prompts or frequent tool calls may trigger web risk control. Doubao XML (default) is recommended for most users.',
  'settings.providers.deepseekToolModeSaved': 'DeepSeek toolchain mode saved',
  'settings.providers.deepseekToolModeRestartHint':
    'Mode changed: stop and restart the Zero-Token gateway, then start a new Claude session.',
  'settings.providers.deepseekToolModeSaveFailed': 'Failed to save DeepSeek toolchain mode',
  'settings.providers.gatewayLicenseTitle': 'Gateway activation',
  'settings.providers.gatewayLicenseHint': 'Activation is required before starting the gateway.',
  'settings.providers.gatewayLicenseCodePlaceholder': 'Activation code',
  'settings.providers.gatewayLicensePurchase': 'Buy activation code',
  'settings.providers.gatewayLicenseActivate': 'Activate',
  'settings.providers.gatewayLicenseLogout': 'Deactivate',
  'settings.providers.gatewayLicenseVerified': 'Activated {masked}, expires: {endtime}',
  'settings.providers.gatewayLicenseNotVerified': 'Not activated — gateway start is blocked',
  'settings.providers.gatewayLicenseActivateSuccess': 'Activation successful',
  'settings.providers.gatewayLicenseActivateFailed': 'Activation failed',
  'settings.providers.gatewayLicenseLogoutSuccess': 'Activation cleared',
  'settings.providers.gatewayLicenseStartBlocked': 'Activate before starting the gateway',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Token Free notifications are enabled',
  ...
  'settings.general.insecureTlsTitle': 'Trust all certificates behind an HTTPS proxy',
  'settings.general.insecureTlsDescription': 'When your machine routes traffic through a MITM proxy (Fiddler, Charles, corporate proxy, etc.), the CLI subprocess fails HTTPS with "unknown certificate verification error" because the proxy uses a self-signed CA. Enabling this option skips TLS verification.',
  'settings.general.insecureTlsEnabled': 'Disable TLS certificate verification',
  'settings.general.insecureTlsHint': 'Off by default. Anyone in the path can decrypt LLM traffic when this is on; only enable it when you trust the local proxy. New sessions pick the change up immediately; the server itself (title generation, etc.) requires a restart.',
