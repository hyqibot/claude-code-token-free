...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.claudeOfficialLogin.openBrowserFailed': '无法自动打开浏览器,请点击授权链接。',
  'settings.claudeOfficialLogin.manualAuthorizeLink': '打开授权链接',
  ...
  'settings.providers.zeroTokenTitle': 'Zero-Token 网关',
  'settings.providers.zeroTokenWebModelHint':
    '如果网关状态不是「运行中」，请点击「启动网关」。',
  'settings.providers.zeroTokenWebModelDeepseekChat': 'DeepSeek 网页',
  'settings.providers.zeroTokenWebModelDoubaoWeb': '豆包 网页',
  'settings.providers.zeroTokenWebModelClaudeWeb': 'Claude 网页',
  'settings.providers.zeroTokenWebModelQwenWeb': 'Qwen 网页',
  'settings.providers.zeroTokenWebModelQwenCnWeb': '通义 网页',
  'settings.providers.zeroTokenWebModelKimiWeb': 'Kimi 网页',
  'settings.providers.zeroTokenWebModelChatgptWeb': 'ChatGPT 网页',
  'settings.providers.zeroTokenWebModelGeminiWeb': 'Gemini 网页',
  'settings.providers.zeroTokenWebModelGlmWeb': 'GLM 网页',
  'settings.providers.zeroTokenWebModelGlmIntlWeb': 'GLM 国际版 网页',
  'settings.providers.zeroTokenNoStatus': '暂无状态。',
  'settings.providers.zeroTokenRunning': '运行中',
  'settings.providers.zeroTokenStoppedState': '已停止',
  'settings.providers.zeroTokenStart': '启动网关',
  'settings.providers.zeroTokenStop': '停止网关',
  'settings.providers.zeroTokenAuthorize': '一键授权',
  'settings.providers.zeroTokenPhaseEnsure': '步骤 1/3：调试浏览器并打开站点',
  'settings.providers.zeroTokenPhaseOnboard': '步骤 2/3：CLI 抓取凭证（onboard）',
  'settings.providers.zeroTokenPhaseKeepalive': '步骤 3/3：启动后台保活',
  'settings.providers.zeroTokenAuthorizeWaiting': '正在连接服务端…',
  'settings.providers.zeroTokenStarted': 'Zero-Token 网关已启动',
  'settings.providers.zeroTokenStopped': 'Zero-Token 网关已停止',
  'settings.providers.zeroTokenAuthorizeSuccess': '已完成授权：{id}（onboard={mode}）',
  'settings.providers.zeroTokenStatusFailed': '读取 Zero-Token 状态失败',
  'settings.providers.zeroTokenStartFailed': '启动 Zero-Token 网关失败',
  'settings.providers.zeroTokenStopFailed': '停止 Zero-Token 网关失败',
  'settings.providers.zeroTokenAuthorizeFailed': '一键授权失败',
  'settings.providers.zeroTokenTlsHint':
    '若聊天出现「unknown certificate verification error」，请到「设置 → 通用」开启「在 HTTPS 代理下信任所有证书」，然后停止并重新启动 Zero-Token 网关，再新建会话重试。',
  'settings.providers.deepseekToolModeLabel': 'DeepSeek 工具链',
  'settings.providers.deepseekToolModeXml': 'Doubao XML（默认，<tool_call>，与豆包一致）',
  'settings.providers.deepseekToolModeDsml': 'DSML（DeepSeek 网页原生格式，可能被风控）',
  'settings.providers.deepseekToolModeDsmlRiskHint':
    'DSML 使用 DeepSeek 专有工具格式，长 prompt 或频繁工具调用可能触发网页风控；一般建议保持 Doubao XML（默认）。',
  'settings.providers.deepseekToolModeSaved': 'DeepSeek 工具链方案已保存',
  'settings.providers.deepseekToolModeRestartHint': '方案已变更：请先停止再启动 Zero-Token 网关，并新建 Claude 会话后生效。',
  'settings.providers.deepseekToolModeSaveFailed': '保存 DeepSeek 工具链方案失败',
  'settings.providers.gatewayLicenseTitle': '网关激活',
  'settings.providers.gatewayLicenseHint': '启动网关前需激活。',
  'settings.providers.gatewayLicenseCodePlaceholder': '输入激活码',
  'settings.providers.gatewayLicensePurchase': '点击跳转购买激活码（日卡可用1月，月卡可用1年）',
  'settings.providers.gatewayLicenseActivate': '激活',
  'settings.providers.gatewayLicenseLogout': '退出激活',
  'settings.providers.gatewayLicenseVerified': '已激活 {masked}，到期：{endtime}',
  'settings.providers.gatewayLicenseNotVerified': '未激活，无法启动网关',
  'settings.providers.gatewayLicenseActivateSuccess': '激活成功',
  'settings.providers.gatewayLicenseActivateFailed': '激活失败',
  'settings.providers.gatewayLicenseLogoutSuccess': '已退出激活',
  'settings.providers.gatewayLicenseStartBlocked': '请先完成激活后再启动网关',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Token Free 通知已启用',
  ...
  'settings.general.insecureTlsTitle': '在 HTTPS 代理下信任所有证书',
  'settings.general.insecureTlsDescription': '当本机走 MITM 抓包代理（如 Fiddler / Charles / 公司代理）时，CLI 子进程的 HTTPS 请求会因代理使用自签 CA 而报 "unknown certificate verification error"。开启后会跳过 TLS 证书校验。',
  'settings.general.insecureTlsEnabled': '禁用 TLS 证书校验',
  'settings.general.insecureTlsHint': '默认关闭。开启后中间人能解密所有 LLM 流量，仅在你信任本机代理时才使用。修改后下一条新会话立即生效，server 自身（标题生成等）需重启进程后生效。',
