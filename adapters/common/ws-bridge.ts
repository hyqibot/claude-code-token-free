...
export class WsBridge {
  ...
  /** Apply provider/model override before the first user_message (mirrors desktop set_runtime_config). */
  ...
  /** WebSocket is connected and ready to send. */
  isSessionOpen(chatId: string): boolean {
    const session = this.sessions.get(chatId)
